    ...
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <div className="flex flex-row justify-between items-center w-full">
        <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
          ...
          <spam className='text-gradient'>Generation</spam>
        </h1>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methodology ro identify the credit cards most likely fo feed your needs . W examine annual percentage rates, annual fees.</p>
    </div>
